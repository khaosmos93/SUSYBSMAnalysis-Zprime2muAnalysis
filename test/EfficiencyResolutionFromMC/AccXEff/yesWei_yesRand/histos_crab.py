...
for eff in [process.EfficiencyFromMCnoTrigger, process.OurEfficiencyFromMCnoTrigger, process.OurEfficiencyFromMCMini, process.EfficiencyFromMCMini]:
    ...
    eff.useRandom = True # weight with random gaus
...
process.HardInteractionFilter.min_mass = "6000"

process.HardInteractionFilter.max_mass = "999999999999999967336168804116691273849533185806555472917961779471295845921727862608739868455469056"

process.HardInteractionFilterRes.min_mass = "6000"

process.HardInteractionFilterRes.max_mass = "999999999999999967336168804116691273849533185806555472917961779471295845921727862608739868455469056"
