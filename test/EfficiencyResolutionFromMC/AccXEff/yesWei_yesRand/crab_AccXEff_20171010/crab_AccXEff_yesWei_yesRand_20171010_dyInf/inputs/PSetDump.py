...
process.HardInteractionFilter = cms.EDFilter("HardInteractionFilter",
    ...
    max_mass = cms.double(999999999999999967336168804116691273849533185806555472917961779471295845921727862608739868455469056),
    max_muon_eta = cms.double(1e+99),
    min_mass = cms.double(6000),
